...
$(function () {
    ...
    function WidthChange(mq) {
        if (mq.matches) {
            $('div.first-name-english').insertAfter($('div.middle-name-english'));
            $('div.family-name-english').insertBefore($('div.middle-name-english'));
        } else {
            $('div.family-name-english').insertAfter($('div.middle-name-english'));
            $('div.first-name-english').insertBefore($('div.middle-name-english'));
        }
    ...
    $('#mobile_number').intlTelInput({
        ...
        utilsScript: "/Assets/js/intlTel-utils.js"
    });
...
function facebook_client_validation_blur() {
    ...
    if (field.value == '') {
        ...
        var regex = /^(((https:\/\/)|(http:\/\/))?(www.)?)?(((facebook)|(fb)|(Fb)).com\/)(([a-zA-Z0-9])+\.)*([a-zA-Z0-9])+$/;
        if (!regex.test(field.value)) {

...
<link rel="shortcut icon" href="/Assets/Images/application_logo.png">
...
<script src="/Assets/js/clientside_validation_v2.js"></script>
...
echo form_upload($height_image_file_upload);?></div>
	<div class="container">
		<div class="row logo">
			<img src="/Assets/Images/application_logo.png"

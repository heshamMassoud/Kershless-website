...
class CI_Email {
	...
	var	$smtp_host		= "ssl://gator2013.hostgator.com";	// SMTP Server.Example: mail.earthlink.net
	var	$smtp_user		= "applications@kershless.com";		// SMTP Username
	var	$smtp_pass		= "LimpBizkit";		// SMTP Password

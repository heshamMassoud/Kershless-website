...
<body id="page-top" class="index">
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="<?php echo base_url(); ?>Assets/Images/kershless-logo.png" class="img-responsive" alt="">
                    <!--
                    <div class="intro-text">
                        <span class="name">Kershless</span>
                        <hr class="star-light">
                        <span class="skills">Web Developer - Graphic Artist - User Experience Designer</span>
                    </div>-->
                    <div class="col-lg-8 col-lg-offset-2 text-center">
                    <a href="<?php echo base_url(); ?>register" class="btn btn-lg btn-outline">
